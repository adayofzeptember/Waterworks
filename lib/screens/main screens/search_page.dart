                ...
                builder: (context, state) {
                  ...
                  return Column(
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return 
                          state.searchResult[index].statusSearchCheck
                    ...
                    InkWell(
                      onTap: () {
                        print('invoice id: ' +
                            state.searchResult[index].invoiceID.toString());
                        ...
                        Navigator.push(
                          ...
                          PageTransition(
                              ...
                              child: Invoice_Page(
                                invoiceID:
                                    state.searchResult[index].invoiceID.toString(), ckeckWidget: 'from_list',
                              )),
                        );
                      },
                      child: Column(
