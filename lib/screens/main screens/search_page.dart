          ...
          child: Column(
            children: [
              ...
              TextField(
                ...
                onSubmitted: ((value) {
                  context.read<SearchBloc>().add(SearchNumber(searchNumber: value));
                }),
                decoration: const InputDecoration(
                    labelText: "ค้นหาด้วยเลข ป. ",
                    prefixIcon: Icon(Icons.search),
                    border: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(230.0)))),
              ),
              const SizedBox(
                height: 15,
              ),
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return state.searchResult[index].statusSearchCheck
                                      ...
                                      child: InkWell(
                                          ...
                                          Navigator.push(
                                            ...
                                            PageTransition(
                                              ...
                                              child: Use_Water_Info(
                                                id: state.searchResult[index].id.toString(),
                                              ),
                                            ),
                                          );
                                          ;
                                        ...
                                        child: Container(
                                          ...
                                          decoration: const BoxDecoration(
                                            color: Colors.white,
                                            border: Border(
                                              left: BorderSide(width: 10.0, color: Palette.thisGreen),
                                            ),
                                          ),
                                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: Text(
                                                          'เลข ป. ' + state.searchResult[index].waterNumber.toString(),
                                                      ...
                                                      state.searchResult[index].status != true
                                                          ? Padding(
                                                  ...
                                                  Container(
                                                    width: 200,
                                                    child: Text(
                                                      state.searchResult[index].customerName,
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Padding(
                                                          padding: const EdgeInsets.only(left: 5, right: 5),
                                                          child: Text(
                                                            state.searchResult[index].customerAddress,
                                                            overflow: TextOverflow.ellipsis,
                                                            style: const TextStyle(
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Padding(
                                                          padding: const EdgeInsets.only(left: 5, right: 5),
                                                          child: Text(
                                                            state.searchResult[index].meterNumber,
                                                            style: const TextStyle(
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Padding(
                                                          padding: const EdgeInsets.only(left: 5, right: 5),
                                                          child: Text(
                                                            state.searchResult[index].areaNumber,
                                                            style: const TextStyle(
                                                                fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black),
                                                          ),
                                                        ),
                                            ...
                                            InkWell(
                                              onTap: (() {
                                                print(state.searchResult[index].id.toString());
                              ...
                              : InkWell(
                                  onTap: () {
                                    print('invoice id: ' + state.searchResult[index].invoiceID.toString());
                                    ...
                                    Navigator.push(
                                      ...
                                      PageTransition(
                                          ...
                                          type: PageTransitionType.rightToLeft,
                                          child: Invoice_Page(
                                            invoiceID: state.searchResult[index].invoiceID.toString(),
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    width: 200,
                                                    child: Text(
                                                      state.searchResult[index].customerName.toString(),
                                                      overflow: TextOverflow.ellipsis,
                                                      maxLines: 1,
                                                      softWrap: false,
                                                      style: const TextStyle(
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Padding(
                                                          padding: const EdgeInsets.only(left: 5, right: 5),
                                                          child: Text(
                                                            state.searchResult[index].customerAddress.toString(),
                                                            overflow: TextOverflow.ellipsis,
                                                            style: const TextStyle(
                                                                fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black),
                                                          ),
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Padding(
                                                          padding: const EdgeInsets.only(left: 5, right: 5),
                                                          child: Text(
                                                            state.searchResult[index].meterNumber.toString(),
                                                            style: const TextStyle(
                                                                fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black),
                                                          ),
                                                        ),
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Padding(
                                                          padding: const EdgeInsets.only(left: 5, right: 5),
                                                          child: Text(
                                                            state.searchResult[index].areaNumber.toString(),
                                                            style: const TextStyle(
                                                                fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black),
                                                          ),
                                                        ),
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  const Text(
                                                    'ดูใบแจ้งหนี้',
                                                    style: TextStyle(
                                                        color: Palette.thisGreen, fontWeight: FontWeight.bold, fontSize: 14),
                                                  )
                                                ],
                                              ),
                                            )
