...
class InvoicePage3 extends StatelessWidget {
  const InvoicePage3({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              BlocBuilder<WritePageBloc, WritePageState>(builder: (context, state) {
                return InkWell(
                    onTap: () async {
                      print(state.whatPage);
                      if (state.whatPage == 'listDone') {
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  ...
                                  Text(state.invoice_data.areaNumber.toString(), style: const TextStyle(fontWeight: FontWeight.bold))
                                ],
                              ),
                            ],
                          ),
