          ...
          return Column(
            children: [
                        ...
                        return Padding(
                          ...
                          child: OutlinedButton(
                            style: OutlinedButton.styleFrom(
                              backgroundColor: (index == state.segmentActive) ? Palette.thisGreen : Colors.white,
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                color: (index == state.segmentActive) ? Colors.white : Palette.thisGreen,
                              ),
                            ),
                          ),
                        );
              ...
              (state.notWrite.isEmpty)
                  ? Padding(
                      padding: const EdgeInsets.all(50.0), child: (state.error == 'not') ? const Text('ไม่มีข้อมูล') : Container())
                  : Container(),
              Expanded(
                child: MediaQuery(
                  ...
                  child: Scrollbar(
                    ...
                    child: Padding(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: (state.isLoading == true && state.dataTotal != state.notWrite.length)
                            ? state.notWrite.length + 1
                            : state.notWrite.length,
                        itemBuilder: (BuildContext context, int index) {
                          if (index == state.notWrite.length && state.dataTotal != state.notWrite.length) {
                            return Padding(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: Text(
                                              ...
                                              softWrap: false,
                                              style: const TextStyle(
                                                  fontWeight: FontWeight.bold, color: Color.fromARGB(255, 83, 83, 83), fontSize: 18),
                                            ),
                                          ),
