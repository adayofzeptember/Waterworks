              ...
              builder: (context, profileState) {
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return BlocBuilder<NotWriteBloc, NotWriteState>(builder: (context, notWriteState) {
                      return Padding(
                  ...
                  child: Scrollbar(
                    ...
                    child: Padding(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount:
                            (state.isLoading == true && state.stopLoad == false) ? state.notWrite.length + 1 : state.notWrite.length,
                        itemBuilder: (BuildContext context, int index) {
                          if (index == state.notWrite.length && state.isLoading == true && state.stopLoad == false) {
                            return Padding(
                              padding: const EdgeInsets.all(50.0),
                              child: Center(
                                  child:
                                            ...
                                            Row(
                                              children: [
                                                Container(
                                                  ...
                                                  child: Text(
                                                    'เลข ป. ' + state.notWrite[index].waterNumber.toString(),
