...
import 'package:waterworks/bloc/write_page/model.dart';
...
class ZplPrintHere {
  printInvoice_Now(
    ...
    bluetooth.isConnected.then((isConnected) {
      print(thisInvoice.fiveMonths_Back_Model);
      if (isConnected == true) {
...
// """;
        ...
        if (checkBill.toString() == "0") {
          bluetooth.printCustom(zplToPrinter1_Invoice, Size.boldMedium.val, Align.center.val);
          bluetooth.paperCut();
        } else {
          zplToPrinter2_Bill = """
^XA~TA000~JSN^LT0^MNN^MTD^PON^PMN^LH0,0^JMA^PR5,5~SD10^JUS^LRN^CI0^XZ
...
""";
          ...
          bluetooth.printCustom(zplToPrinter1_Invoice, Size.boldMedium.val, Align.center.val);
          bluetooth.printCustom(zplToPrinter2_Bill, Size.boldMedium.val, Align.center.val);
