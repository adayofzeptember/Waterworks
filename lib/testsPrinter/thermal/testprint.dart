...
import 'package:waterworks/testsPrinter/thermal/enum.dart';
  ...
  sample() async {
    ...
    bluetooth.isConnected.then((isConnected) {
      if (isConnected == true) {
        ...
        bluetooth.printCustom("HEADER", SizeX.boldMedium.val, Align.center.val);
        bluetooth.printNewLine();
        ...
        bluetooth.printNewLine();
        bluetooth.printLeftRight("LEFT", "RIGHT", SizeX.medium.val);
        bluetooth.printLeftRight("LEFT", "RIGHT", SizeX.bold.val);
        bluetooth.printLeftRight("LEFT", "RIGHT", SizeX.bold.val,
            format:
                "%-15s %15s %n"); //15 is number off character from left or right
        bluetooth.printNewLine();
        bluetooth.printLeftRight("LEFT", "RIGHT", SizeX.boldMedium.val);
        bluetooth.printLeftRight("LEFT", "RIGHT", SizeX.boldLarge.val);
        bluetooth.printLeftRight("LEFT", "RIGHT", SizeX.extraLarge.val);
        bluetooth.printNewLine();
        bluetooth.print3Column("Col1", "Col2", "Col3", SizeX.bold.val);
        bluetooth.print3Column("Col1", "Col2", "Col3", SizeX.bold.val,
            format:
                "%-10s %10s %10s %n"); //10 is number off character from left center and right
        bluetooth.printNewLine();
        bluetooth.print4Column("Col1", "Col2", "Col3", "Col4", SizeX.bold.val);
        bluetooth.print4Column("Col1", "Col2", "Col3", "Col4", SizeX.bold.val,
            format: "%-8s %7s %7s %7s %n");
        bluetooth.printNewLine();
        bluetooth.printCustom("čĆžŽšŠ-H-ščđ", 2, Align.center.val,
            charset: "windows-1250");
        bluetooth.printLeftRight("Številka:", "18000001", SizeX.bold.val,
            charset: "windows-1250");
        bluetooth.printCustom("Body left", SizeX.bold.val, Align.left.val);
        bluetooth.printCustom("Body right", SizeX.medium.val, Align.right.val);
        bluetooth.printNewLine();
        bluetooth.printCustom("Thank You", SizeX.bold.val, Align.center.val);
        bluetooth.printNewLine();
